...
RoutesTransformer.prototype._transform = function (data, encoding, done) {
  var subject = "http://data.gtfs.org/routes/" + this._feedname + "/" + data["route_id"];
  ...
  if (data["agency_id"]) {
    this.push({ subject: subject, predicate: "http://vocab.gtfs.org/terms#agency", object: "http://data.gtfs.org/agencies/" + this._feedname + "/" + data["agency_id"]});
  }
