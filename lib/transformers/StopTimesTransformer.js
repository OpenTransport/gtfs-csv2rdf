...
StopTimesTransformer.prototype._transform = function (data, encoding, done) {
  ...
  if (data["shape_dist_traveled"]){
    this.push({ subject: subject, predicate: "http://vocab.gtfs.org/terms#distanceTraveled", object: '"' + data["shape_dist_traveled"] + '"^^http://www.w3.org/2001/XMLSchema#nonNegativeInteger'});
  }
  done();
};
