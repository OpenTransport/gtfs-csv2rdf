...
CalendarTransformer.prototype._transform = function (data, encoding, done) {
  ...
  var servicerule = subject + "/calendarrule";
  ...
  if (data["tueday"]) {
    this.push({ subject: servicerule, predicate: "http://vocab.gtfs.org/terms#tueday", object: ( data["tueday"] === "1"?"\"true\"":"\"false\"" ) + "^^http://www.w3.org/2001/XMLSchema#boolean"});
  }
  if (data["wednesday"]) {
