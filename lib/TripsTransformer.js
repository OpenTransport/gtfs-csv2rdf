...
TripsTransformer.prototype._transform = function (data, encoding, done) {
  ...
  if (data["shape_id"]) {
    this.push({ subject: this._feedbaseuri + "/shapes/" + data["shape_id"], predicate: "http://www.w3.org/1999/02/22-rdf-syntax-ns#type", object: "http://vocab.gtfs.org/terms#Shape"});
