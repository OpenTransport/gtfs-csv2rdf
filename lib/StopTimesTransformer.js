...
StopTimesTransformer.prototype._transform = function (data, encoding, done) {
  var subject = "http://data.gtfs.org/stoptimes/" + this._feedname + "/" + data["trip_id"] + data["stop_id"];
  ...
  this.push({ subject: subject, predicate: "http://vocab.gtfs.org/terms#stop", object: "http://data.gtfs.org/" + this._feedname + "/stops/"  + data["stop_id"]});
  this.push({ subject: subject, predicate: "http://vocab.gtfs.org/terms#trip", object: "http://data.gtfs.org/" + this._feedname + "/trips/" + data["trip_id"]});
